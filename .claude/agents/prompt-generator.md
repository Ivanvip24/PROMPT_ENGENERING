...
Consult `/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/pueblos_magicos_list.md` for the complete official list of 177 Pueblos Mágicos. If the destination matches ANY town on that list, you MUST automatically add the Pueblos Mágicos logo requirement to the prompt using the description from `common_design_elements.md`.
