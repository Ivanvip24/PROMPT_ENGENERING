...
### Working Directory:
```
/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/Generate Variations from an Existing Design
```
...
### Working Directory:
```
/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/Design from Scratch
```
...
### Working Directory:
```
/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/Design Based on a Previous Element
```
...
### Working Directory:
```
/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/MODIFY_DESIGN
```
...
```bash
# Test Project 1
cd "/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/Generate Variations from an Existing Design"
echo "Create a tiger variation" | claude

# Test Project 2
cd "/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/Design from Scratch"
echo "Create design for Hermosillo" | claude

# Test Project 3 (will show generic greeting)
cd "/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/Design Based on a Previous Element"
echo "Create design" | claude

# Test Project 4 (will show generic greeting)
cd "/Users/ivanvalenciaperez/Desktop/CLAUDE/READY/PROMPT_ENGENERING/MODIFY_DESIGN"
